...
import main.scala.placerT.algo.hw.CPBus
import main.scala.placerT.metadata.sw.Transmission
import main.scala.placerT.metadata.sw.TransmissionTiming.TransmissionTiming
import oscar.cp._
